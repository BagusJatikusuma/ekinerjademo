 ...
 */
@Embeddable
public class TargetSuratPerintahPejabatId implements Serializable {
    @Column(name = "kd_surat_perintah")
    private String kdSuratPerintah;
    @Column(name = "kd_jabatan")
    private String kdJabatan;

    public TargetSuratPerintahPejabatId() {
    }
    public TargetSuratPerintahPejabatId(String kdSuratPerintah, String kdJabatan) {
    ...
    public boolean equals(Object o) {
        ...
        TargetSuratPerintahPejabatId that = (TargetSuratPerintahPejabatId) o;
