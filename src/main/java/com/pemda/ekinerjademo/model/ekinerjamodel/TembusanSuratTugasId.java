 ...
 */
@Embeddable
public class TembusanSuratTugasId implements Serializable {
    @Column(name = "kd_surat_tugas")
    private String kdSuratTugas;
    @Column(name = "kd_jabatan")
    private String kdJabatan;

    public TembusanSuratTugasId() {
    }
    public TembusanSuratTugasId(String kdSuratTugas, String kdJabatan) {
    ...
    public boolean equals(Object o) {
        ...
        TembusanSuratTugasId that = (TembusanSuratTugasId) o;
