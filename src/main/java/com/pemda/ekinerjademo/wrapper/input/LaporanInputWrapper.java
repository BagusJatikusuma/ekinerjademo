...
public class LaporanInputWrapper {
    ...
    private String kegiatanYangDilakukan;
    ...
    public String getKegiatanYangDilakukan() {
        return kegiatanYangDilakukan;
    }

    public void setKegiatanYangDilakukan(String kegiatanYangDilakukan) {
        this.kegiatanYangDilakukan = kegiatanYangDilakukan;
    }
    ...
    public String getKdLaporanBawahan() {
        return kdLaporanBawahan;
    }

    public void setKdLaporanBawahan(String kdLaporanBawahan) {
        this.kdLaporanBawahan = kdLaporanBawahan;
    }
}
