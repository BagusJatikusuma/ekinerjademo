 ...
 */
public class NodinTemplateInputWrapper {
    ...
    private List<String> tembusanSurat;
    ...
    public List<String> getTembusanSurat() {
        return tembusanSurat;
    }

    public void setTembusanSurat(List<String> tembusanSurat) {
