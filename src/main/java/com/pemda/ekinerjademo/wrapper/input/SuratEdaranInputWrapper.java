...
public class SuratEdaranInputWrapper {
    ...
    public Long getTanggalSuratEdaranMilis() {
        return tanggalSuratEdaranMilis;
    }

    public void setTanggalSuratEdaranMilis(Long tanggalSuratEdaranMilis) {
        this.tanggalSuratEdaranMilis = tanggalSuratEdaranMilis;
    }
