...
public class SuratUndanganInputWrapper {
    ...
    public Long getTanggalSuratUndanganMilis() {
        return tanggalSuratUndanganMilis;
    }

    public void setTanggalSuratUndanganMilis(Long tanggalSuratUndanganMilis) {
        this.tanggalSuratUndanganMilis = tanggalSuratUndanganMilis;
    }
    ...
    public List<String> getKdTembusanList() {
        return kdTembusanList;
    }

    public void setKdTembusanList(List<String> kdTembusanList) {
    ...
    public void setKdSuratUndanganBawahan(String kdSuratUndanganBawahan) {
        this.kdSuratUndanganBawahan = kdSuratUndanganBawahan;
    }
