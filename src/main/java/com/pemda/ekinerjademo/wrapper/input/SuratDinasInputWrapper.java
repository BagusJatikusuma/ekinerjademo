...
public class SuratDinasInputWrapper {
    ...
    private String kotaPembuatanSuratDinas;
    ...
    public Long getTanggalSuratDinasMilis() {
        return tanggalSuratDinasMilis;
    }

    public void setTanggalSuratDinasMilis(Long tanggalSuratDinasMilis) {
        this.tanggalSuratDinasMilis = tanggalSuratDinasMilis;
    }

    public String getKotaPembuatanSuratDinas() {
        return kotaPembuatanSuratDinas;
    }

    public void setKotaPembuatanSuratDinas(String kotaPembuatanSuratDinas) {
        this.kotaPembuatanSuratDinas = kotaPembuatanSuratDinas;
    }
