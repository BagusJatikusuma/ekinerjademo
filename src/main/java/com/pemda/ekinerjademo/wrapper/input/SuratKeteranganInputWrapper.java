...
public class SuratKeteranganInputWrapper {
    ...
    private List<String> nipPegawaiKeterangan;
    private String isiSuratKeterangan;
    private String kotaPembuatanSurat;
    private Long tanggalSuratKeteranganMilis;
    private String nipPembuatSurat;
    private String kdUnitKerja;
    private Integer durasiPengerjaan;
    private String kdSuratKeteranganBawahan;
    ...
    public List<String> getNipPegawaiKeterangan() {
        return nipPegawaiKeterangan;
    }

    public void setNipPegawaiKeterangan(List<String> nipPegawaiKeterangan) {
    ...
    public Long getTanggalSuratKeteranganMilis() {
        return tanggalSuratKeteranganMilis;
    }

    public void setTanggalSuratKeteranganMilis(Long tanggalSuratKeteranganMilis) {
        this.tanggalSuratKeteranganMilis = tanggalSuratKeteranganMilis;
    }
    ...
    public String getKdSuratKeteranganBawahan() {
        return kdSuratKeteranganBawahan;
    }

    public void setKdSuratKeteranganBawahan(String kdSuratKeteranganBawahan) {
        this.kdSuratKeteranganBawahan = kdSuratKeteranganBawahan;
    }
